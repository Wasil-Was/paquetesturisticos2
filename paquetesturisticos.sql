...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-10-2021 a las 17:59:26
...
('12436520', 'John Baltica', 938576323, 'balticrazy@gmail.com', '1987-01-01'),
...
INSERT INTO `paquete` (`ID_Paquete`, `descripcion`, `hospedaje`, `restaurante`, `automovil`, `cantPersonas`) VALUES
(1001, 'Este paquete turístico cuenta con hospedaje, restaurante y automóvil, además de acceso a Wi-Fi, y Sanitización por Covid-19 en todas las locaciones.', 'Hotel Mercure Santiago Centro', 'Krossbar', 'Mazda CX 5', 1),
(1002, 'Este paquete turístico cuenta con automóvil, el cual cuenta con asiento de bebes, herramientas de Sanitización por Covid-19 y aire acondicionado en el vehículo.\r\nEspectacular para viajar por el pais con la familia.', 'No Aplica', 'No Aplica', 'Ssangyong Korando', 3),
(1003, 'Este paquete turístico cuenta con un vehículo espectacular y capacidad para dos personas, con Wi-Fi en el vehículo.\r\nGran opción para disfrutar con un amigo o en pareja paseando por el país.', 'No Aplica', 'No Aplica', 'Lamborghini Urus', 2),
(1004, 'Este paquete turístico cuenta hospedaje y acceso a restaurante, además de acceso a Wi-Fi, y Sanitización por Covid-19 en todas las locaciones. Ideal para disfrutar y pasear por la ciudad conociendo gente.\n', 'Hotel Santibañez de la Mancha', 'Zanzíbar', 'No Aplica', 1),
(1005, 'Este paquete turístico cuenta hospedaje y acceso a restaurante, además de acceso a Wi-Fi y Sanitización en las locaciones.\r\nEspectacular para disfrutar de la ciudad con la familia.', 'Hotel Panamericano', 'Gran Refugio', 'No Aplica', 4);
...
(80386, 1003, '18123456', 'Economica', 55, 550000),
...
(1313, 386, 'Aeropuerto Internacional Arturo Merino Benítez', 'Aeropuerto de Argentina', 'Chile', 'Argentina', '2021-10-10', '2021-10-12', '05:00:00', '12:00:00'),
